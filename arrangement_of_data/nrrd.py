...
def make_out_dirs(dataset_id: int, task_name="SEGA"):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--dataset_id", required=False, type=int, default=50, help="nnU-Net Dataset ID, default: 27"
    )
    args = parser.parse_args()
    print("Converting...")
    convert_acdc('/data/scratch/acw676/nn/data0/', args.dataset_id)
    print("Done!")
